  ...
  try {
    ...
    if (!staffId) {
      return new Response(
        JSON.stringify({
          success: false,
          code: "6058_27",
          title: t(`errorCode.6058_27.title`),
          message: t(`errorCode.6058_27.description`),
          error: t(`errorCode.6058_27.description`),
        }),
        {
          status: 400,
        }
    ...
    if (!staff) {
      return new Response(
        JSON.stringify({
          success: false,
          code: "6058_28",
          title: t(`errorCode.6058_28.title`),
          message: t(`errorCode.6058_28.description`),
          error: t(`errorCode.6058_28.description`),
        }),
        {
          status: 404,
        }
    ...
    return new Response(
      JSON.stringify({
        success: true,
        code: "6058_29",
        title: t(`errorCode.6058_29.title`),
        message: t(`errorCode.6058_29.description`),
        data: staff,
      }),
      { status: 200 }
    );
    ...
    return new Response(
      JSON.stringify({
        success: false,
        code: "6058_30",
        title: t(`errorCode.6058_30.title`),
        message: t(`errorCode.6058_30.description`),
        error: t(`errorCode.6058_30.description`),
      }),
      { status: 500 }
    );
  }
        ...
        return NextResponse.json(
          {
            success: false,
            code: "6058_31",
            title: t(`errorCode.6058_31.title`),
            message: t(`errorCode.6058_31.description`),
            error: t(`errorCode.6058_31.description`),
          },
          { status: 400 }
        );
      }
      ...
      return NextResponse.json(
        {
          success: false,
          code: "6058_32",
          title: t(`errorCode.6058_32.title`),
          message: t(`errorCode.6058_32.description`),
          error: t(`errorCode.6058_32.description`),
        },
        { status: 500 }
      );
    }
    ...
    return NextResponse.json(
      {
        success: false,
        code: "6058_33",
        title: t(`errorCode.6058_33.title`),
        message: t(`errorCode.6058_33.description`),
        message: t(`errorCode.6058_33.description`),
        staff: updatedStaff,
      },
      { status: 200 }
    ...
    return NextResponse.json(
      {
        success: false,
        code: "6058_34",
        title: t(`errorCode.6058_34.title`),
        message: t(`errorCode.6058_34.description`),
        error: t(`errorCode.6058_34.description`, {
  ...
  try {
    ...
    if (!deletedStaff) {
      return new Response(
        JSON.stringify({
          success: false,
          code: "6058_35",
          title: t(`errorCode.6058_35.title`),
          message: t(`errorCode.6058_35.description`),
          error: t(`errorCode.6058_35.description`),
        }),
        { status: 404 }
      );
    }
    ...
    return new Response(
      JSON.stringify({
        success: true,
        code: "6058_36",
        title: t(`errorCode.6058_36.title`),
        message: t(`errorCode.6058_36.description`),
      }),
      { status: 200 }
    );
  } catch (error) {
