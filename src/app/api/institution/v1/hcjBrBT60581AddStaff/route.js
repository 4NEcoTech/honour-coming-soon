...
export async function POST(req) {
  ...
  try {
        ...
        return NextResponse.json(
          {
            success: false,
            code: "6058_23",
            title: t(`errorCode.6058_23.title`),
            message: t(`errorCode.6058_23.description`),
            error: t(`errorCode.6058_23.description`),
          },
          { status: 400 }
        );
      }
      ...
      return NextResponse.json(
        {
          success: false,
          code: "6058_24",
          title: t(`errorCode.6058_24.title`),
          message: t(`errorCode.6058_24.description`),
          error: t(`errorCode.6058_24.description`),
        },
        { status: 400 }
      );
    }
    ...
    const invite = new CompanyContactPerson({
      ...
      CCP_Contact_Person_Document_Domicile:
        data.CCP_Contact_Person_Document_Domicile || "N/A",
      CCP_Contact_Person_Document_Type:
        data.CCP_Contact_Person_Document_Type || "N/A",
      CCP_Contact_Person_Document_Number:
        data.CCP_Contact_Person_Document_Number || "N/A",
      CCP_Contact_Person_Document_Picture:
    ...
    return NextResponse.json(
      {
        success: false,
        code: "6058_25",
        title: t(`errorCode.6058_25.title`),
        message: t(`errorCode.6058_25.description`),
      },
      { status: 200 }
    );
  } catch (error) {
    ...
    return NextResponse.json(
      {
        error: t(`errorCode.6058_26.description`),
        success: false,
        code: "6058_26",
        title: t(`errorCode.6058_26.title`),
        message: t(`errorCode.6058_26.description`),
        details:
