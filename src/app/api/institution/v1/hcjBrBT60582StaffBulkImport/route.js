...
//   } catch (error) {
//     console.error(`Failed to send email to ${teamMember.CCP_Contact_Person_Email}:`, error);
//     return { success: false, email: teamMember.CCP_Contact_Person_Email, error: error.message };
//   }
// }

// async function validateTeamMemberRecord(record, institutionNum, institutionName, companyId, adminInviteeId) {
//   const errors = [];
//   const validatedRecord = { ...record };

//   // Apply default values
//   validatedRecord.CCP_Contact_Person_Country = validatedRecord.CCP_Contact_Person_Country || DEFAULT_VALUES.CCP_Contact_Person_Country;
//   validatedRecord.CCP_Contact_Person_Document_Domicile = validatedRecord.CCP_Contact_Person_Document_Domicile || DEFAULT_VALUES.CCP_Contact_Person_Document_Domicile;
...
//   if (validatedRecord.CCP_Contact_Person_Gender in genderMap) {
//     validatedRecord.CCP_Contact_Person_Gender = genderMap[validatedRecord.CCP_Contact_Person_Gender];
//   } else {
//     errors.push(`Invalid Gender: ${validatedRecord.CCP_Contact_Person_Gender}`);
//   }

//   // Convert Role to Code
//   if (validatedRecord.CCP_Contact_Person_Role in roleMap) {
//     validatedRecord.CCP_Contact_Person_Role = roleMap[validatedRecord.CCP_Contact_Person_Role];
//   } else {
...
//         batch.map(record => validateTeamMemberRecord(
//           record,
//           institutionNum,
//           institutionName,
//           companyId,
...
//       // Insert valid team members in batches
//       if (validTeamMembers.length > 0) {
//         try {
//           await CompanyContactPerson.insertMany(validTeamMembers.slice(
//             validTeamMembers.length - batchResults.filter(r =>
...
//           invalidTeamMembers.push(...validTeamMembers.slice(
//             validTeamMembers.length - batchResults.filter(r =>
//               r.status === 'fulfilled' && r.value.errors.length === 0
//             ).length
//           ).map(record => ({
      ...
      return NextResponse.json(
        {
          success: false,
          code: "6056_17",
          title: t(`errorCode.6056_17.title`),
          message: t(`errorCode.6056_17.description`),
          error: t(`errorCode.6056_17.description`),
        },
        { status: 400 }
      );
    }
      ...
      return NextResponse.json(
        {
          success: false,
          code: "6056_18",
          title: t(`errorCode.6056_18.title`),
          message: t(`errorCode.6056_18.description`),
          error: t(`errorCode.6056_18.description`),
        },
        { status: 400 }
      );
    }
      ...
      return NextResponse.json(
        {
          success: false,
          code: "6056_19",
          title: t(`errorCode.6056_19.title`),
          message: t(`errorCode.6056_19.description`),
          error: t(`errorCode.6056_19.description`),
          details: error.message,
        },
        { status: 400 }
      );
    ...
    return NextResponse.json(
      {
        success: true,
        code: "6056_20",
        title: t(`errorCode.6056_20.title`),
        message: t(`errorCode.6056_20.description`),
        validCount: validTeamMembers.length,
        invalidCount: invalidTeamMembers.length,
        duplicateCount,
        bulkImportId,
    ...
    return NextResponse.json(
      {
        success: false,
        code: "6056_21",
        title: t(`errorCode.6056_21.title`),
        message: t(`errorCode.6056_21.description`, { message: error.message }),
        error: t(`errorCode.6056_21.description`, { message: error.message }),
        details: error.message,
        stack: process.env.NODE_ENV === "development" ? error.stack : undefined,
      },
      { status: 500 }
    ...
    return NextResponse.json(
      {
        success: false,
        code: "6056_22",
        title: t(`errorCode.6056_22.title`),
        message: t(`errorCode.6056_22.description`, { message: error.message }),
        error: t(`errorCode.6056_22.description`, { message: error.message }),
      },
      { status: 500 }
    );
  }
