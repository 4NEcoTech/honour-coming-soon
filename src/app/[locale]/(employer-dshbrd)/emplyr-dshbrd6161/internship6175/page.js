...
export default function InternshipPostingPage() {
      ...
      <div className="max-w-3xl mx-auto p-4 md:p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h1 className="text-xl font-semibold">UX/UX Designer and Illustrator</h1>
              <p className="text-sm text-muted-foreground">Internship opportunity</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span>Remote (Anywhere in the US)</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-5 space-y-2 text-sm">
            ...
            <li>
              Illustrating requirements into user guides, design systems, UI pattern libraries and interactive user
              interfaces
            </li>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc pl-5 space-y-1 text-sm">
            ...
            <li>Design/Creative Students</li>
          </ul>
        </div>
        ...
        <div className="mb-6 p-4 border rounded-md bg-gray-50 dark:bg-gray-800">
          <p className="text-center font-medium">Application will close on 02/01/2024</p>
        </div>
        ...
        <Card className="p-4 mb-6 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-2">Unlock these benefits for this Internship:</p>
        ...
        <div className="text-xs text-center text-muted-foreground">
          <p>You will be the first candidate, and others might try to contact for this internship.</p>
