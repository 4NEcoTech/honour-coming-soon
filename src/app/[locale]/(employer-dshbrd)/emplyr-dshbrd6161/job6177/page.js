  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="max-w-3xl mx-auto p-4 md:p-6">
        ...
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Full-time position</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
        ...
        {/* About the Position */}
        <div className="mb-6">
          <h2 className="text-lg font-semibold mb-3">About the Position</h2>
        ...
        <Card className="p-4 mb-6 border-blue-200 dark:border-blue-800 bg-blue-50 dark:bg-blue-950">
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mb-2">Unlock these benefits for this Job:</p>
        ...
        <div className="text-xs text-center text-muted-foreground">
          <p>You will be the first candidate, and others might try to contact for this job.</p>
