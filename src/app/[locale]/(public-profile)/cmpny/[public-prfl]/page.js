...
export default function InstitutionPublicProfilePage() {
  ...
  const institutionId = params?.["public-prfl"]; // Extract institution ID from dynamic route
  ...
  // Slider settings for staff section
  const sliderSettings = {
    dots: false,
    infinite: staffMembers.length > 4,
    speed: 500,
    slidesToShow: 4,
    slidesToScroll: 1,
    autoplay: true,
          ...
          {staffMembers.length === 0 && (
            <div className="text-center py-8 mb-8 bg-gray-50 dark:bg-gray-800 rounded-lg">
              ...
              <p className="text-muted-foreground dark:text-gray-400">
                This institution hasn&apos;t added any team members yet.
              </p>
            </div>
          )}
        </div>
