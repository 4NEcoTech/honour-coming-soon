...
const formSchema = (t) =>
  z.object({
    addressLine1: z.string().min(1, t("6029_1")),
    addressLine2: z.string().optional(),
    landmark: z.string().optional(),
    city: z.string().min(1, t("6029_2")),
    state: z.string().min(1, t("6029_3")),
    country: z.string().min(1, t("6029_4")),
    pincode: z.string().min(6, t("6029_5")),
  });
