        ...
        switch (res.status) {
          ...
          case 409: // Conflict
            toast({
              ...
              description: t(responseData.message),
              // responseData.message || 'Validation error. Please try again.',
              action: (
      ...
      <Card className="w-full max-w-lg p-8 rounded-lg sm:shadow-lg sm:border border-none  shadow-none sm">
        <CardHeader>
          <CardTitle className=" text-2xl md:text-zxl lg:text-4xl text-center font-thin">
            {tCommon("RegistrationWithCredentialForm.title")}
          </CardTitle>
          <CardDescription>
            {tCommon("RegistrationWithCredentialForm.subtitle")}
          </CardDescription>
        </CardHeader>
        {/* Form */}
        <CardContent className="space-y-4">
          {/* LinkedIn Button */}
          {/*Linked in register in not complited yet */}
          {/* <div>
