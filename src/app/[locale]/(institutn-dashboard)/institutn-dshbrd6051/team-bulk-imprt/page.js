...
export default function TeamBulkDataUpload() {
  ...
  const handleFileChange = (e) => {
    ...
    if (file) {
      ...
      if (
        ...
        Swal.fire({
          icon: "error",
          title: tError("6056_12.title"),
          text: tError("6056_12.description"),
      ...
      if (file.size > maxSize) {
        Swal.fire({
          icon: "error",
          title: tError("6056_13.title"),
          text: tError("6056_13.description"),
          confirmButtonText: "Okay",
        });
        return;
      }
  ...
  const handleUpload = async () => {
    if (!uploadedFile) {
      Swal.fire({
        icon: "error",
        title: tError("6056_14.title"),
        text: tError("6056_14.description"),
        confirmButtonText: "Okay",
      });
      return;
    }
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: tError("6056_15.title"),
        html: `
          <p>${result.message}</p>
          <p><b>${tError("6056_15.desc1")}</b> ${result.validCount}</p>
          <p><b>${tError("6056_15.desc2")}</b> ${result.invalidCount}</p>
          <p><b>${tError("6056_15.desc3")}</b> ${result.duplicateCount}</p>
          <p>${tError("6056_15.description")}</p>
        `,
      ...
      Swal.fire({
        icon: "error",
        title: tError("6056_16.title"),
        text: tError("6056_16.title", { message: errorMessage }),
        showCancelButton: true,
