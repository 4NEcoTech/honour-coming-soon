...
const HCJStudentSchema = new mongoose.Schema(
  ...
  //  HCJ_ST_Student_Id: { type: String, unique: true },
    ...
    HCJ_ST_Student_Document_Domicile: { type: String},
    HCJ_ST_Student_Document_Type: { type: String },
    HCJ_ST_Student_Document_Number: { type: String },
    ...
    HCJ_ST_Score_Grade_Type: { type: String},
    HCJ_ST_Score_Grade: { type: String },
